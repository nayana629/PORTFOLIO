...
function validateSubject()
{
  ...
  if(left>0)
  {
    subError.innerHTML=left + 'more characters required';
    return false;
  }

  subError.innerHTML='<i class="bi bi-check-circle"></i>';
  return true;
}
function validateMessage()
{
  ...
  msgError.innerHTML='<i class="bi bi-check-circle"></i>';
  return true;
}
...
function sendMail()
{
  ...
  emailjs.send("service_q18xxuo","template_2x86gdp",parms).then(alert("Email Sent!!"))
}